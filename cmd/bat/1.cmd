...
>nul rd /q /s %BaseName%
@echo -----------------------------------------------------------------------
@echo Создание пустой базы call %Path32% CREATEINFOBASE File=%BaseName% /Out %Log%
@echo Создание пустой базы >> "00_cre.log"
call %Path32% CREATEINFOBASE File=%BaseName% /Out %Log%
...
call %Path32% DESIGNER %Base% /Out %Log% /N %LoginDB% /P %PassDB% /ConfigurationRepositoryF %PathHRN% /ConfigurationRepositoryN %LoginHRN% /ConfigurationRepositoryP %PassHRN% /ConfigurationRepositoryUpdateCfg -revised -force /UpdateDBCfg -Server /DisableStartupMessages /DisableStartupDialogs
@echo RC: %ERRORLEVEL%
