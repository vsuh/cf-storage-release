...
Процедура ПолучитьОтчет()
	...
	// Лог.Информация("Каталог временной базы: v8-tmp" + ИмяИб);
	// УправлениеКонфигуратором.УстановитьКонтекст("/F v8-tmp" + ИмяИб, "", "");
	...
	Лог.Отладка("Удаляю временные файлы из v8r_TempDB");
